...
const OverviewComponent: React.FC = () => {
    return (
        <div>
            ...
            <OverviewLandingPage imageSrc={LoRaLanding}/> {/* Render OverviewLandingPage component */}
            <OverviewLandingSlider
                imageSrc={LoRa_1} // Image for the OverviewLandingSlider
                title={'Das Projekt!'}
                subtitle={
                ...
                flipped={false} /* Setting the state if the text or image state are flipped or not, defined in
                OverviewLandingSlider */
            />
            <OverviewLandingSlider
                imageSrc={LoRa_2}
